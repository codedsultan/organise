...
class ForgotPasswordController extends Controller
{
    public function showForgotForm(){
        return view('dashboard.vendor.forgot');
    }
    public function sendResetLink(Request $request){
        ...
        $action_link = route('vendor.reset.password.form',['token'=>$token,'email'=>$request->email]);
    ...
    public function showResetForm(Request $request, $token = null){
        return view('dashboard.vendor.reset')->with(['token'=>$token,'email'=>$request->email]);
    }
    ...
    public function resetPassword(Request $request){
        ...
        if(!$check_token){
            ...
            return redirect()->route('vendor.login')->with('info', 'Your password has been changed! You can login with new password')->with('verifiedEmail', $request->email);
        }
    }
}
